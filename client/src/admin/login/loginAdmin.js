...
import useFormLogin from "./useFormLoginAdmin";
import validationLogin from "./validationLoginAdmin";
import "../../index.css";
import axios from "axios";
import ErreurMessage from "../../proprietaire/commun/erreurMessage";
...
const LoginAdmin = () => {
 ...
 /* function submit() {
    ...
    //fetch("http://localhost:3100/admins/all", {
     // method: "POST",
     // body: values,
    //}).then((res) => res.json());
        ...
        {window.location.href = "http://localhost:3000/AdminListeStade";}
else{ setErreurMsg("check your email or password");}       
